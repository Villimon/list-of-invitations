...
const Success = ({ invites }) => {
    return (
        <div className='success' >
            ...
            <h3 className="success__title">Успешно!</h3>
            <p className="success__text">Всем {invites.length} пользователям отправлено приглашение</p>
            <button onClick={()=> window.location.reload()} className="success__btn">Назад</button>
        </div>
    );
}
